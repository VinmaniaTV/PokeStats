<template>
  <div>
    ...
    <div id="showcase">
      ...
      <div>
        <p>
          PokéStats est une plateforme permettant d'améliorer la gestion des Pokémons.<br />
          Cet outil est développé dans un but éducatif et convient à donner des
          suggestions non exhaustives.<br />
        </p>
      </div>
    </div>
