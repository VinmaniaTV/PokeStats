    ...
    <nav class="navbar navbar-expand-lg">
      <router-link class="navbar-brand" to="/"
        ><img
          ...
          class="img-fluid"
          width="48"
        /><span>PokéStats</span></router-link
      >
      <button
      ...
      >
        <span class="navbar-toggler-icon"
          ><img src="./img/menu.png" class="img-fluid" width="30"
        /></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mr-auto w-100 d-flex justify-content-end">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/pokedex">Pokédex</router-link>
          </li>
...
.navbar .nav-item:nth-child(n + 2):before {
  content: "";
  position: absolute;
  width: 2px;
  height: 15px;
